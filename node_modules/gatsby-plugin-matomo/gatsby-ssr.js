...
function buildTrackingCode(pluginOptions) {
  ...
  var script = localScript ? localScript : matomoUrl + "/piwik.js";
...
function buildTrackingCodeNoJs(pluginOptions, pathname) {
  ...
  var html = "<img src=\"" + matomoUrl + "/piwik.php?idsite=" + siteId + "&rec=1&url=" + (siteUrl + pathname) + "\" style=\"border:0\" alt=\"tracker\" />";
